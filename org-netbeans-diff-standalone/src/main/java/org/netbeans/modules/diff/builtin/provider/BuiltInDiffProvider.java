...
public class BuiltInDiffProvider extends DiffProvider implements java.io.Serializable {
    ...
    public String getDisplayName() {
        ...
        return ResourceBundle.getBundle("Bundle").getString("BuiltInDiffProvider.displayName");
    }
    ...
    public String getShortDescription() {
        ...
        return ResourceBundle.getBundle("Bundle").getString("BuiltInDiffProvider.shortDescription");
    }
    ...
    public Difference[] computeDiff(Reader r1, Reader r2) throws IOException {
        if (options == null) {
			...
			//Ranga
            //options = DiffModuleConfig.getDefault().getOptions();options = DiffModuleConfig.getDefault().getOptions();
            options = new Options();
        }
