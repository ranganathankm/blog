package com.blogspot.ranganathankm.nbdiff.client.test;
 ...
 * @author ranga
 */
public class TestCmdLineDiffClient
{

    /**
     * Creates new form TestDiffClient
     */
    public TestCmdLineDiffClient()
    {
    }

    void showDiff(String filePath1, String filePath2)
            throws FileNotFoundException, IOException, BadLocationException
    {
        ...
        DiffProvider diff = new CmdlineDiffProvider(); //(DiffProvider) Lookup.getDefault().lookup(DiffProvider.class);        
    ...
    void showUnifiedDiff(String filePath1, String filePath2)
            throws FileNotFoundException, IOException, BadLocationException
    {
        Difference[] differences;
        File file1 = new File(filePath1);
    ...
    {
        TestCmdLineDiffClient testDiffClient = new TestCmdLineDiffClient();
