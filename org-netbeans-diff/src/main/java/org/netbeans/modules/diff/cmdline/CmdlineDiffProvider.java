...
public class CmdlineDiffProvider extends DiffProvider implements java.io.Serializable {
    ...
    public String getDisplayName() {
        ...
        return ResourceBundle.getBundle("Bundle").getString("displayName");
    }
    ...
    public String getShortDescription() {
        ...
        return ResourceBundle.getBundle("Bundle").getString("shortDescription");
    }
...
//            f2 = FileUtil.normalizeFile(File.createTempFile("TempDiff".intern(), null));
    ...
    //Ranga
    //this method has been removed as we are not dealing with org.openide.filesystems.FileObject
    /**
    ...
    private Difference[] createDiff(File f1, File f2) throws IOException {
        ...
        if (pattern == null) {
            try {
                ...
                IOException ioe = new IOException(resex.getLocalizedMessage() ,resex);
                throw ioe;
            }
            //firstText = new StringBuffer();
            //secondText = new StringBuffer();
        ...
        Runnable cancellableProcessWrapper = new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(CmdlineDiffProvider.class.getName()).log(Level.FINE, "#69616 CDP: executing: " + cmd); // NOI18N
                    synchronized(p) {
                    ...
                    final String str = ResourceBundle.getBundle("Bundle").getString("runtimeError");
                    IOException ioe = new IOException(MessageFormat.format(str, cmd) ,ioex);
                    ret[0] = ioe;
